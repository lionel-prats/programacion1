...
pygame.display.set_caption("VIDEO 9 - PROFESOR")
...
while run:
    ...
    if main_menu == True:
        ...
        # si el player pierde la vida paralizo a los blobs
        if game_over == 0:
...
# cd /Users/User/Desktop/utn/cuatrimestre1/programacion_1/PYGAME_PRACTICAS/4.juego_tipo_mario/video9/video_09
# python main.py
