...
pygame.display.set_caption("POO - Version 2")
...
background_surface = pygame.transform.scale(background_surface, screen_dimentions)

sun_img_path, sun_img_coord_x, sun_img_coord_y, sun_height, sun_width = configs.get("screen").get("images").get("sun").values()
sun_surface = pygame.image.load(sun_img_path)
sun_surface = pygame.transform.scale(sun_surface, (sun_height, sun_width))
...
# cd /Users/User/Desktop/utn/cuatrimestre1/programacion_1/PYGAME_PRACTICAS/4.juego_tipo_mario/zz_v2
# python main.py