...
class Platform(pygame.sprite.Sprite):
    def __init__(self, path_image, x, y, tile_size, move_x, move_y, move_direction, amplitud):
    ...
    def update(self):
        ...
        if abs(self.move_counter) > self.amplitud: # infinite loop -> 50f to right, 100f to left, 100f to right, 100f to left...
