...
pygame.display.set_caption("VIDEO 13 - PROFESOR")
...
class Player():
    ...
    def update(self, game_over):
        ...
        if game_over == 0:
            ...
            for tile in world.tile_list: 
                ...
                if tile[1].colliderect(self.rect.x, self.rect.y + dy, self.width, self.height): 
                    # hay colision entre el player y el top o el bottom de alguno de los tiles
                    ...
                    if self.vel_y < 0: # el player esta durante la curva de un salto, entonces la colision es entre el bottom del tile y el top del player
        ...
        # pygame.draw.rect(screen, (255,0,0), self.rect, 2) # v13
...
class World():
    ...
    def draw(self):
        for tile in self.tile_list:
            ...
            # pygame.draw.rect(screen, (255,255,255), tile[1], 2) v13
...
# cd /Users/User/Desktop/utn/cuatrimestre1/programacion_1/PYGAME_PRACTICAS/4.juego_tipo_mario/video13/video_13
# python main.py
