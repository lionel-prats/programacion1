...
def main_app(lista_personajes: list[dict]):
  ...
  while True:
    ...
    match opcion_seleccionada:
      ...
      case "1":
        titulo = "1- Listado superhéroes (nombre):"
        lista_heroes_nombre = reducir_diccionarios_en_lista(lista_personajes, ["nombre"])

        imprimir_lista_de_diccionarios(lista_heroes_nombre, titulo)
