...
lista_inputs_validos = ["a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o", "z"]
texto_default = "Elija una opcion: "

def imprimir_menu_desafio_5():
  limpiar_consola()
  imprimir_dato(menu["desafio_01"])
...
def continuar(input_usuario: str) -> bool:
  ...
  retorna: True si el input es valido o False si es "z"
  """
...
def existe_elemento_en_lista(elemento: str, lista: list):
  """  
...
if __name__ == "__main__":
  ...
  print(existe_elemento_en_lista("z", lista_inputs_validos))
  print(existe_elemento_en_lista("Z", lista_inputs_validos))
...
# cd Desktop/utn/cuatrimestre1/programacion_1/ENTREGAS/stark/05
