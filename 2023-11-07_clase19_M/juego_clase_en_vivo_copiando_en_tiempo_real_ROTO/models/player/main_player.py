...
class Jugador:
    ...
    def __init__(self, coord_x, coord_y, frame_rate = 100, speed_walk = 6, speed_run = 12, gravity = 16, jump = 32):
        ...
        # sprites para que el personaje mire a un lado o al otro
        self.__iddle_r = sf.get_surface_from_spritesheet("./assets/img/player/iddle/player_iddle.png", 6, 1)
        self.__iddle_l = sf.get_surface_from_spritesheet("./assets/img/player/iddle/player_iddle.png", 6, 1, flip = True)
        
        # sprites para que el personaje camine a un lado o al otro
        ...
        # sprites para que el personaje salte a un lado o al otro
    ...
    def do_animation(self, delta_ms):
        ...
        if self.__player_animation_time > self.__frame_rate:
            self.__player_animation_time = 0
            if self.__initial_frame > len(self.__actual_img_animation - 1):
