...
pygame.display.set_caption("VIDEO 27 CLASE 0")
...
monstruo_rectangulo.x = 200
monstruo_rectangulo.y = 200
frames_monstruo = 0


def entro_al_campo_de_vision(a, b, distancia):
    if (math.sqrt(((b.x - a.x)**2) + ((b.y - a.y)**2))) < distancia:
        return True
    else:
        return False
...
while jugando:
    ...
    if entro_al_campo_de_vision(jugador_rectangulo, monstruo_rectangulo, 250):
        print("DENTRO DEL CAMPO DE VISION DEL MONSTRUO")
    else:
        print("NO PASA NARANJA")
    monstruo_rectangulo.center = (640,360)
    ventana.blit(monstruo_imagen, monstruo_rectangulo)

    pygame.draw.line(surface=ventana, color=(255,0,0), start_pos=(0, 360), end_pos=(640, 360), width=2)
    pygame.draw.line(surface=ventana, color=(255,0,0), start_pos=(640, 0), end_pos=(640, 360), width=2)
    pygame.draw.circle(surface=ventana, color=(255,0,0), center=(640,360),radius=250, width=1)
